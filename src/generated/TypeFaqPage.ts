 ...
 * @version 3
 */
export type TypeFaqPageSkeleton = EntrySkeletonType<
  TypeFaqPageFields,
  'faqPage'
>
/**
 ...
 * @version 3
 */
export type TypeFaqPage<
  Modifiers extends ChainModifiers,
  Locales extends LocaleCode = LocaleCode,
> = Entry<TypeFaqPageSkeleton, Modifiers, Locales>

export function isTypeFaqPage<
  Modifiers extends ChainModifiers,
  Locales extends LocaleCode,
>(
  entry: Entry<EntrySkeletonType, Modifiers, Locales>,
): entry is TypeFaqPage<Modifiers, Locales> {
